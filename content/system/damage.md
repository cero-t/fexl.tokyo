...
### 浮動小数点を考慮したコンボ補正率と防御力補正率の合算（仮説）

上に書いた通りにコンボ補正率と防御力補正率を踏まえて計算した時に、ダメージの値が1ずれることがある。現時点では仮説だが、浮動小数点の演算により値がずれている可能性がある。詳細な説明は省くが、浮動小数点の演算を踏まえてコンボ補正率から防御補正率を引いた値は、次の通りとなる。

|ヒット数|コンボ補正率 - 防御力補正率|浮動小数点を考慮した倍率|
|--------|------------|------------|
|1|85|0.85|
|2|85|0.85|
|3|65|0.65|
