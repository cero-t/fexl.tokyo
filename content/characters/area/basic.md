...
{{% panel theme="default" header="(31) しゃがみ弱K→しゃがみ中K→ジャクソンキック(中)→パーティションブレイク" %}}エリアの基本となるコンボ。ガードされた場合は派生技やスーパーキャンセルでの読み合いとなる。パンチボタンを使わないため、キャンサーが手元になくても同じコンボが入れられる{{% /panel %}}
