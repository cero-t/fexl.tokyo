...
{{% panel theme="default" header="(立ち中K→)しゃがみ強P→強サッカーボールキック" %}}ジャック・アッパー後に少し前歩きした後、なるべく低空でコンボ開始すると成功しやすい。立ち中Kは難しければ省いても良い。{{% /panel %}}


{{% panel theme="default" header="(立ち中K→)しゃがみ強P→強サッカーボールキック→ジャック・アッパー→垂直ジャンプ強P→ダッシュ立ち中P→しゃがみ強P→強バッティングヒーロー→グランドスラムクラッシャー" %}}強サッカーボールキックの後のジャック・アッパーは高く浮くため垂直ジャンプ下り強Pを挟めるが、距離が離れるのでその後にダッシュ立ち中Pを挟む必要がある。このダッシュ立ち中P→しゃがみ強Pのパーツは他コンボでも重宝する。画面端の場合は強サッカーボールキック→ジャック・アッパーがスカリやすいので、強サッカーボールキックの代わりに強バッティングヒーローを高めに当てると同じルートへ行ける。{{% /panel %}}
