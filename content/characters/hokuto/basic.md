...
{{% panel theme="default" header="(84) しゃがみ弱K→しゃがみ中K→肘激崩→連昇激→｛(しゃがみ中P)→ダッシュ中K→強K→連昇激｝x2→くだりJ強K→中P→強K" %}}全キャラに安定して入れることができる空中コンボ。連昇激の後にしゃがみ中Pを空振りすることでフレーム消費をして、タイミングを取りやすくしている。{{% /panel %}}

{{% panel theme="default" header="(105) ダッシュしゃがみ中K→強P→刈蹴→連昇激→｛(しゃがみ中P)→ダッシュ中K→強K→連昇激｝x2→くだりJ強K→中P→強K" %}}中足からスタートするコンボ。補正が少ないうちに強の攻撃が入るため、ダメージが高くなりやすい。{{% /panel %}}

[相手キャラ別のコンボも含めたコンボは、中上級コンボを参照](../combo)
