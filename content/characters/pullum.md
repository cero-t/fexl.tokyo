...
s
{{% panel theme="default" header="(67) （立った相手に）ダッシュしゃがみ中P(持続部分Hit)→ダッシュ立ち弱P→しゃがみ中P→しゃがみ中P→しゃがみ中K→強ドリル＊プルス(地上)→プラエク＊ラーム" %}}ゲージ回収優先のレシピ。{{% /panel %}}

{{% panel theme="default" header="(69) （立った相手に）ダッシュしゃがみ中P(持続部分Hit)→ダッシュ立ち弱P→立ち中K→しゃがみ強P→強ドリル＊プルス(地上)→プラエク＊ラーム" %}}ダメージ優先のレシピ。{{% /panel %}}

{{% panel theme="default" header="(69) （立った相手に）ダッシュしゃがみ中P→立ち弱P→しゃがみ弱P→しゃがみ中P→ダッシュ立ち弱P→しゃがみ中P→しゃがみ中P→しゃがみ中K→強ドリル＊プルス(地上)→プラエク＊ラーム" %}}エリア限定。最速でつなぐと4Hit目のしゃがみ中Pが持続Hitとなりダッシュ立ち弱Pに繋がる。{{% /panel %}}
