...
|強P|ガードさせても確反を受けない、エリアとしては数少ない技|
...
|しゃがみ中P|他のキャラとは異なり、立ちガード不可の下段攻撃。また、ここから弱攻撃や中攻撃の目押しには繋げられない|
...
|技 |解説|
|---|----|
|前投げ|通常投げ。ダウンを奪った後の猶予時間が少し長いため、安全にアップロードを出しやすい|
|後ろ投げ|相手との左右位置を入れ替える投げ。猶予時間が前投げに比べて短く、投げた直後に最速でアップロードを出しても、一部のキャラのリバーサル攻撃を受けてしまう|
...
{{% panel theme="default" header="リバースギア (N4P / 214P)" %}}エミュレーターで吸収した飛び道具を打つ。飛び道具の性能変換についての詳細は、次項を参照{{% /panel %}}
